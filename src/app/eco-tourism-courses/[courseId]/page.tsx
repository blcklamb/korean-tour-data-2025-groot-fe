...
import { Copy, Leaf, Loader2, MapPin, Phone, ThumbsUp } from "lucide-react";
...
export default function EcoTourCourseDetailPage() {
  ...
  const displayCourse: EcoTourCourseDetail | undefined = course;
      ...
      {displayCourse && (
        <>
            ...
            <div className="overflow-hidden rounded-lg border bg-white shadow-sm">
              ...
              <div className="space-y-4 p-6">
                <div className="flex flex-wrap items-center justify-between gap-3 text-sm text-gray-600">
                  ...
                  <span>
                    조회수 {displayCourse.viewCount.toLocaleString()}회
                  </span>
                  <span>
                    총 탄소 배출량{" "}
                    {displayCourse.totalCarbonEmission.toFixed(1)}kg CO₂e
                  </span>
                  <span>
                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                  ...
                  <div className="flex flex-col items-end gap-2">
                    <Button
                      ...
                      disabled={
                        shouldUseMockData || toggleLikeMutation.isPending
                      }
                    ...
                    >
                      ...
                      {likeButtonLabel} (
                      {displayCourse.likeCount.toLocaleString()})
                    </Button>
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-1 text-sm text-gray-600">
                        ...
                        <Button
                          ...
                          onClick={() => {
                            if (navigator.clipboard) {
                              navigator.clipboard.writeText(spot.address1);
                              toast.success(
                                "주소가 클립보드에 복사되었습니다."
                              );
                            }
                      ...
                      <p className="flex items-center gap-2">
                        ...
                        1인당 탄소 배출량{" "}
                        {spot.carbonEmissionPerPerson.toFixed(1)}
                        kg CO₂e
                      </p>
                    </div>
          ...
          <div className="text-xs text-gray-300 text-right mb-2">
            본 페이지의 이미지들은 한국관광공사에서
            <br /> 공공누리 제1 유형 및 제 3유형으로 개방한 이미지들을
            사용하였습니다
          </div>
        </>
      )}
